...
\begin{document}
	...
	%TODO Que se passe t-il si on translate le trou parallement à l'axe optique. 
	...
	\begin{bigcenter}
		\begin{multicols}{2}
			...
			\vfill
			\bgroup
			\includegraphics[scale=0.075,trim=20cm 15cm 0 30cm,clip]{res/"fente 20170207_163022"}
